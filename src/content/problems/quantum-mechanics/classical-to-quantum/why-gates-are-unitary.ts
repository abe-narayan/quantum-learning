...
export const whyGatesAreUnitary: MultipleChoiceProblem = {
  ...
  question: {
    ...
    options: [
      ...
      { id: "b", text: "Unitary matrices are easier to multiply together in a circuit" },
      { id: "c", text: "Gates must be unitary so that they have real eigenvalues" },
      { id: "d", text: "It's a convention chosen for convenience, not a physical requirement" },
    ],
  },
  answer: {
    type: "multiple-choice",
    correctOptionId: "a",
    optionFeedback: {
      b: "Computational convenience isn't the physical reason — the requirement traces to Postulate 4 and normalization preservation.",
      c: "Real eigenvalues is the Hermitian requirement (for observables), not the unitary requirement (for dynamics) — different postulate entirely.",
