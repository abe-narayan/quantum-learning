...
export const whyResonanceDependsOnK2L: ConceptualProblem = {
  ...
  answer: {
    ...
    requiredConceptGroups: [
      ["sin^2(k2*L)", "only appears through this combination", "the formula only depends on the product"],
      ["round-trip phase", "phase accumulated crossing the barrier", "like a thin film"],
    ],
