...
export const secondResonantWidth: NumericProblem = {
  ...
  answer: {
    ...
    value: 2.5651,
    tolerance: 0.001,
    incorrectFeedback: "The n-th resonance occurs at L = n*pi/k2. Since n=1 gives L≈1.2825, n=2 is double that.",
    nearMisses: [
  ...
  hints: [
    { text: "A resonance is where the reflected amplitude cancels itself, which happens when the barrier holds a whole number of half wavelengths." },
    { text: "Write that condition as $k_2L=n\\pi$. The energy and barrier height are the same for both resonances, so $k_2$ does not change between them." },
    { text: "With $k_2$ held fixed, $L_n$ depends on $n$ alone and does so linearly. Scale the given $n=1$ width rather than recomputing $k_2$ from scratch." },
  ],
  solution: {
    steps: [
  ...
  explanation: {
    ...
    whyWrong: ["Recomputing k2 differently for n=2, as if k2 depended on n, misunderstands that k2 is fixed by E and V0 alone. Only L changes between resonances."],
  },
};
