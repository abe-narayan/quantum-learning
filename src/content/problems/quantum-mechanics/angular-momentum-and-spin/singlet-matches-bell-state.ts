...
export const singletMatchesBellState: MultipleChoiceProblem = {
  ...
  answer: {
    ...
    optionFeedback: {
      ...
      c: "|Φ⁺⟩ involves |00⟩ and |11⟩, but the singlet involves |01⟩ and |10⟩ (i.e. ↑↓ and ↓↑) — different basis terms entirely.",
      d: "Same issue as |Φ⁺⟩ — wrong basis terms for the singlet.",
    },
  ...
  hints: [
    ...
    { text: "This exactly matches |Ψ⁻⟩'s definition." },
  ],
  solution: {
