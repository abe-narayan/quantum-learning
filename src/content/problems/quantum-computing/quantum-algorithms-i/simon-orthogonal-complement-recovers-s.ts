...
export const simonOrthogonalComplementRecoversS: ConceptualProblem = {
  ...
  answer: {
    ...
    requiredConceptGroups: [
      ["n-1 independent constraints", "n-1 linearly independent equations", "each constraint cuts the dimension"],
      ["one-dimensional subspace", "exactly one nonzero vector", "orthogonal complement has dimension one"],
      ["s itself satisfies every constraint", "s is orthogonal to each measured z", "by construction s is one of the solutions"],
    ],
    incorrectFeedback:
