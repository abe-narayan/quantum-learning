...
export const simonWhyZeroStringUninformative: ConceptualProblem = {
  ...
  answer: {
    ...
    requiredConceptGroups: [
      ["true for every s", "holds for any s", "satisfied regardless of s", "true no matter what s is"],
      ["no constraint", "trivial equation", "0 equals 0", "tells you nothing new"],
      ["discard it", "measure again", "doesn't narrow down", "useless run"],
    ],
    incorrectFeedback:
