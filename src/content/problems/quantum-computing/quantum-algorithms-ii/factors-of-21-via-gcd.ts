...
export const factorsOf21ViaGcd: MultipleChoiceProblem = {
  ...
  question: {
    ...
    prompt: "Using a=2, N=21, and the order r=6 (from the previous problem), which pair of factors does gcd(2^(r/2)±1, 21) produce?",
    options: [
      { id: "a", text: "3 and 7" },
      { id: "b", text: "1 and 21" },
      { id: "c", text: "2 and 10.5" },
      { id: "d", text: "6 and 3.5" },
    ],
  },
  answer: {
    ...
    optionFeedback: {
      ...
      c: "Factors of an integer are always integers — this isn't a valid gcd output.",
      d: "Same issue — gcd always returns an integer, and 21's actual prime factorization is 3×7.",
    },
  ...
  explanation: {
    ...
    whyWrong: ["Any non-integer answer misunderstands what gcd computes; option b describes what happens only when the reduction fails, which it doesn't here."],
  },
};
