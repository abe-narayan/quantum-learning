...
export const pPlusAtTwoThirdsPiPhase: NumericProblem = {
  ...
  answer: {
    ...
    nearMisses: [
      { value: 0.5, feedback: "0.5 is P(0), the computational-basis probability. It is deliberately blind to δ, which is why the X basis is the one that reveals a relative phase." },
