...
export const capstoneToolboxTrotterStepsT10: NumericProblem = {
  ...
  answer: {
    ...
    value,
    tolerance: 2,
    incorrectFeedback: "Plug t=10, ‖[A,B]‖=4√2, ε=0.001 directly into n = ceil(t²‖[A,B]‖/(2ε)).",
  },
  hints: [
    { text: "The formula is n ≥ t²‖[A,B]‖/(2ε), then round up to the nearest integer." },
    { text: "t²=100, and 2ε=0.002, so compute 100 × 5.656854 / 0.002." },
    { text: "100 × 5.656854 = 565.6854; dividing by 0.002 gives 282,842.7 — round up." },
  ],
  solution: {
    steps: [
  ...
  explanation: {
    correctIdea: "The same exact, derived Trotter error formula this course reused throughout scales quadratically in t — a concrete illustration of why QSVT-based simulation's linear-in-t scaling is a genuine asymptotic improvement, not just a rebranding.",
