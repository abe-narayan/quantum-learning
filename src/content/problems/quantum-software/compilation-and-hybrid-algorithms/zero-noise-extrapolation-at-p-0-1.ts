...
export const zeroNoiseExtrapolationAtP01: NumericProblem = {
  ...
  solution: {
    steps: [
      ...
      { description: "This lands close to, but not exactly at, the true ideal value 1. The residual of about 1.45% is the O(p²) curvature the linear fit drops, larger than the lesson's own p=0.05 case (about 0.37%) because the residual scales roughly with p², and (0.1/0.05)²=4." },
    ],
  ...
  explanation: {
    ...
    whyCorrect: "Evaluating (1-p)^λ at λ=1 and λ=3 gives two points on the noise-amplification curve, and the straight line through them, extended back to λ=0, is the mitigated estimate. The lesson runs the same two-point procedure at p=0.05.",
    whyWrong: [
