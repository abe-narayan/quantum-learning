...
export const rydbergBlockadeMechanism: MultipleChoiceProblem = {
  ...
  question: {
    ...
    options: [
      { id: "a", text: "One atom's Rydberg excitation shifts its neighbor's levels, so the neighbor cannot reach that same state at the same time" },
  ...
  explanation: {
    ...
    whyCorrect: "Matches the lesson's Rydberg blockade description.",
    whyWrong: [
