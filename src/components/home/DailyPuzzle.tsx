 ...
 * Date), which meant the *entire* problem registry, hints and answers
...
export function DailyPuzzle({
  ...
  /** Passed straight through: the card's title has to sit at whatever level
   *  the host section's outline leaves for it. */
  ...
  return <DailyPuzzleClient previews={previews} headingLevel={headingLevel} />;
}
