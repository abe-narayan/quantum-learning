...
export const FIXED_GATES: FixedGateDefinition[] = [
  {
    ...
    explanation: "Rotates the state by π about the X axis — swaps |0⟩ and |1⟩.",
  },
  {
    id: "Y",
    label: "Y",
  ...
  },
  {
    ...
    explanation: "Rotates the state by π about the Z axis — flips the phase of |1⟩ without changing measurement probabilities.",
  },
  {
    id: "H",
    label: "H",
    ...
    explanation: "Rotates by π about the diagonal axis between X and Z — turns a pole into an equal superposition.",
  },
  {
    id: "S",
    label: "S",
    ...
    explanation: "A quarter-turn about the Z axis — changes the phase φ without touching θ or the measurement probabilities.",
  },
  {
    id: "T",
    label: "T",
