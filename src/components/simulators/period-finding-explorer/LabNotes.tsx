 ...
 * try, and where to go next — rendered underneath the live peak-spacing
 * narration box. Kept as its own tiny component so the framing content
 * stays easy to scan separately from the live-computed narration above it.
 */
