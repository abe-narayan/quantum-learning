...
// eyebrow/title/description, then the two-column graph viewport + detail
// panel.
  ...
  return (
    <Container className="animate-pulse py-16">
      ...
      <div className="mt-12 grid gap-4 lg:grid-cols-[1fr_360px]">
        ...
        <div className="flex min-h-[200px] flex-col items-center justify-center gap-2 rounded-2xl border border-border bg-surface p-6 lg:max-h-[652px]">
